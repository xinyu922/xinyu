...
public:
    ...
    void pubHusky()
    {
        ...
        if (huskyStamped_.transform.translation.x==0 && huskyStamped_.transform.translation.y==0 && huskyStamped_.transform.translation.z==0)
            return;
    ...
    void pubHuskyTraj()
    {
        ...
        if (huskyRTSStamped_.transform.translation.x==0 && huskyRTSStamped_.transform.translation.y==0 && huskyRTSStamped_.transform.translation.z==0)
            return;
