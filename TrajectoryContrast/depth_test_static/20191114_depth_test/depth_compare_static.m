...
close all;
% 
rts_filename='RTS/20191114_leadsense_128_1.csv';            %load rts csv file
camera_filename = 'sensor/20191114_128_1_leadSense_depth.csv';     %load camera file
...
legend('sensor depth','rts depth','Location','best'); 
grid on;
grid minor;
