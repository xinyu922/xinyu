...
def evaluate_depth(camera_name):
    ...
    for i in range(num):
        ...
        if camera_name == 'zed':
            camera_path = r'D:\工作\测试项目\深度图_全站仪\camera_data\20200515\zed_depth\zed_depth_' + str(i) + '.csv'
            ...
            camera_path = r'D:\工作\测试项目\深度图_全站仪\camera_data\202005220\leadsense_depth_20200520\leadsense_depth\leadSense_depth_' + str(i) + '.csv'
            camera_depth_matrix = np.genfromtxt(camera_path, delimiter=',')
            ...
            camera_path = r'D:\工作\测试项目\深度图_全站仪\camera_data\202005220\mynt_depth_20200520\mynt_depth\mynt_depth_' + str(i) + '.csv'
            camera_depth_matrix = np.genfromtxt(camera_path, delimiter=',')
    ...
    if camera_name == 'zed':
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\zed\20200514\result\valid_ratio', valid_ratio)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\zed\20200514\result\evaluate_ratio', evaluate_ratio)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\zed\20200514\result\mean_error_with_edge', mean_error)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\zed\20200514\result\evaluate_ratio_without_edge', evaluate_ratio_without_edge)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\zed\20200514\result\mean_error_without_edge', mean_error_without_edge)

        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\zed\20200514\result\diff_error', diff_error)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\zed\20200514\result\diff_error_without_edge', diff_error_without_edge)

    elif camera_name == 'leadsense':
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\leadsense\20200520\result\valid_ratio', valid_ratio)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\leadsense\20200520\result\evaluate_ratio', evaluate_ratio)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\leadsense\20200520\result\mean_error_with_edge', mean_error)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\leadsense\20200520\result\evaluate_ratio_without_edge', evaluate_ratio_without_edge)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\leadsense\20200520\result\mean_error_without_edge', mean_error_without_edge)

        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\leadsense\20200520\result\diff_error', diff_error)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\leadsense\20200520\result\diff_error_without_edge', diff_error_without_edge)

    elif camera_name == 'mynt':
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\mynt\20200520\result\valid_ratio', valid_ratio)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\mynt\20200520\result\evaluate_ratio', evaluate_ratio)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\mynt\20200520\result\mean_error_with_edge', mean_error)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\mynt\20200520\result\evaluate_ratio_without_edge', evaluate_ratio_without_edge)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\mynt\20200520\result\mean_error_without_edge', mean_error_without_edge)

        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\mynt\20200520\result\diff_error', diff_error)
        np.save(r'D:\工作\测试项目\深度图_全站仪\DepthTest\mynt\20200520\result\diff_error_without_edge',diff_error_without_edge)
