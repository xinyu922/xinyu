...
rosbag_file = '/media/dzsb078/D82A47592A4733B2/00_Dataset/无人车_数据集/rosbag/ty2/demo/demo.bag'
data_save_path = '/media/dzsb078/D82A47592A4733B2/00_Dataset/无人车_数据集/rosbag/ty2/demo/'
...
class GetSensorData():
    ...
    def multithread(self):
        t1 = td.Thread(target=self.get_image_left, args=())
        t2 = td.Thread(target=self.get_image_right, args=())
        t3 = td.Thread(target=self.get_imu, args=())
        t1.start()
        t2.start()
        t3.start()
        t1.join()
